...
const About = () => {
  return (
    <section id="about" className="px-4 md:px-8 xl:px-12 py-20 md:py-24 lg:py-28 bg-neutral-900 text-neutral-100">
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div className="flex flex-col gap-6 max-w-xl">
          ...
          <p className="text-neutral-300 text-lg md:text-xl xl:text-[22px] leading-[1.6]">
            Frontend Developer focused on building high-performance web
            interfaces for SaaS teams, consultants, and service businesses.
          </p>

          <p className="text-neutral-500 text-base md:text-lg xl:text-xl leading-[1.7]">
            I combine clean frontend engineering with thoughtful content
            structure to create websites that communicate clearly, load fast,
            and convert—from lead generation to meaningful client enquiries.
          </p>
        </div>
